...
class CollectionsController extends ActionController {
        ...
        public function Index() {
                ...
                // Tüm koleksiyonları göstermek için type_id filtresini kaldırdık
                $qr_collections = ca_collections::find(array('preferred_labels' => ['is_preferred' => 1]), array('returnAs' => 'searchResult', 'checkAccess' => $this->opa_access_values, 'sort' => $vs_sort));
